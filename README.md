...
Figma for creating user-friendly UI designs inlcuding website and mobile apps. For backend development, I’m proficient in Node.js, Express.js, python, c# and Java.
In the blockchain domain, I’ve spent years working with Web3.js, Ether.js, and smart contract frameworks like Hardhat, Truffle, and Remix. I’ve built several websites, trading bots, Tg-miniapps, AI-agent and dApps like NFT marketplaces, token launchpad, swap, staking and P2E crypto games, gaining deep experience in tools like WAGMI and smart contract auditing.
